...
def generate_rst():
    ...
    # generate the rst files
    os.system("sphinx-apidoc -o src/rst/ --force --separate --maxdepth=2 --no-headings ../src/")

    # remote the unused files
    os.remove("src/rst/modules.rst")
...
project = u'Blender-VR Temple Source'
...
exclude_patterns = ['build', 'dummy', 'venv']
...
htmlhelp_basename = 'Blender-VR-Temple-Source-doc'
...
latex_documents = [
  ('index', 'blender-vr-temple-source-api.tex', u'Blender-VR Temple Source',
...
# hack to add non-standard modules (e.g., bge, ...)
import imp
def import_dummy():
    name = 'dummy'
